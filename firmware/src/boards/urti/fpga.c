...
void fpga_io_init(void)
{
	...
	// Turn on FPGA power domain.
	gpio_set_pin_level(FPGA_ENABLEN, true);
	gpio_set_pin_direction(FPGA_ENABLEN, GPIO_DIRECTION_OUT);
	gpio_set_pin_level(FPGA_ENABLEN, false);
	board_delay(10);
}
